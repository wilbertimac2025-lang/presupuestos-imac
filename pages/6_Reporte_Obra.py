...
if doc:
    try:
        # Conectamos con TODAS las bases de datos al mismo tiempo
    ...
    # Buscar folios disponibles (Activos y Cerrados)
    ...
    if folio_seleccionado != "Selecciona un folio...":
        ...
        cliente = obra_info.get("Cliente", "N/A")
        proyecto = obra_info.get("Proyecto", "N/A")
        estatus = obra_info.get("Estatus", "N/A")
        ...
        # 3. EL DESGLOSE TOTAL (Separado por pestañas para que se vea limpio)
